...
if(WIN32)
    ...
    target_link_libraries(${TARGET_NAME} PRIVATE avdevice)
    target_link_libraries(${TARGET_NAME} PRIVATE avfilter)
    target_link_libraries(${TARGET_NAME} PRIVATE avformat)
    target_link_libraries(${TARGET_NAME} PRIVATE avutil)
    target_link_libraries(${TARGET_NAME} PRIVATE postproc)
    target_link_libraries(${TARGET_NAME} PRIVATE swresample)
    target_link_libraries(${TARGET_NAME} PRIVATE swscale)
